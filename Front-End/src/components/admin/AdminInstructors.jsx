...
const AdminInstructors = () => {
    ...
    useEffect(()=>{
        ...
        const getInstructors = async () => {
            ...
            try {
                const response = await fetch(back_end_url+'/users?role=Instructor', requestOptions);
        ...
        <div>
            ...
            <div className="w-[20%] bg-gradient-to-b from-[#D0D0D0] to-[#f2f2f28c] ml-[10%] my-4 rounded-[10px]">
                ...
                <div className="m-auto mx-[30%] relative bottom-[20px]">
                    <span className="text-[#808080] font-bold text-[1.3vw]">{(dataLoaded?instructors.totalCount:"")}</span>
            ...
            <div className="flex mx-[10%] mt-6 text-[#747474]">
                <span>{dataLoaded?instructors.users.length:''} of {dataLoaded?instructors.users.length:''} items</span>
